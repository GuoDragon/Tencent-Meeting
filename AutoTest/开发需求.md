...
2. 但是我发现你在`D:\android_template\Tencent-Meeting\`中新增了一些json文件，我不太理解：现在这些eval脚本到底是在检测winddows本地的json文件还是在检测AndroidStudio中的虚拟机中的文件（我的目的是检测AndroidStudio中的虚拟机中的文件）？是否支持我在虚拟机中执行相应操作，写入新的文件后，再通过相应脚本来检验
3. json文件都要变成易读的格式，注意缩进换行