...
## 可参考的截图
D:\android_template\Tencent-Meeting\ui\ShareScreenDetails.jpg

## 你当前的任务
把所有页面的顶部都改成和ShareScreenDetails页面一样连贯，而不是有明显的颜色分界线（比如主颜色是白色，顶部却是淡蓝色）。每个页面的原主颜色不变，只是样式要连接平滑起来。