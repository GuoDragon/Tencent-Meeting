...
## 当前开发需求
1. 仿造`D:\android_template\AppSim\src\appsim\tasks`中各种应用的检测方法，来写我的这个TencentMeeting任务的检测脚本
2. 注意`D:\android_template\AppSim\src\appsim\tasks`里的内容只能看不要动
3. 目前已经有了一些脚本放在`D:\android_template\Tencent-Meeting\AutoTest`，只在这个文件夹里进行操作
4. 我想写的新的检测任务是
序号	指令名
1	在技术讨论会议（会议号Meeting_3d7e91）中打开自己的麦克风
2	在技术讨论会议（会议号Meeting_3d7e91）中打开自己的摄像头
4	在技术讨论会议（会议号Meeting_3d7e91）中关闭所有人的麦克风
5	在技术讨论会议（会议号Meeting_3d7e91）中发送消息“大家好”
6	保持默认配置创建一场快速会议
7	预约一场会议，时间定为明天晚上八点，邀请所有好友参加
13	查看最近一场会议的会议主题和会议时长
28	通过会议号Meeting_5d8e21共享屏幕
29	将“个人会议室”的“等候室”设置为“开启”，然后进入会议室
